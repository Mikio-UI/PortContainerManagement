...
import java.util.ArrayDeque; import java.util.Scanner;

class Container { String id; String description; String weight;
...
class Ship { String name; String captain;
...
public class PortContainerManagement { public static void main(String[] args) { Scanner sc = new Scanner(System.in);
